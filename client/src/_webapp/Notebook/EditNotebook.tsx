...
import { useEditNotebook } from "../../lib/Tanstack/mutation/mutations";
...
const EditNotebook = () => {
  ...
  const { mutateAsync: updateNotebook, isPending: isUpdating } =
    useEditNotebook();
  ...
  useEffect(() => {
    const handleKey = (e: KeyboardEvent) => {
      ...
      switch (e.key) {
        ...
        case "k":
          e.preventDefault();
          insertMarkdown("link", "Click Here");
          break;
        case "g":
          e.preventDefault();
          insertMarkdown("image", "Image Alt");
          break;
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.success("Notebook berhasil diperbarui!");
    navigate(`/webapp/notebook/${id}`);
  };

  if (isPending)
    return (
      <p className="text-center mt-20 opacity-60">Loading notebook…</p>
    );
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              value={title}
              placeholder="Edit judul notebook…"
          ...
          <textarea
            ...
            placeholder="Edit isi notebook di sini..."
